		...
		<div class="container">	
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-6">
					<div class="headline">
						<h1 style="border-bottom: none;">{$description_text|escape:'html':'UTF-8'}</h1>
					</div>
					{$form_content|escape:'html':'UTF-8'}	
				</div>
	...
	<footer id="footer_remarkety" class="section nopadding-bottom">
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6">
					...
					<ul class="quick-links">
						<li><a target="_blank" href="http://www.remarkety.com/?utm_source=plugin&utm_medium=link&utm_campaign=prestashop-plugin">www.remarkety.com</a></li>
						<li><a target="_blank" href="https://app.remarkety.com/?utm_source=plugin&utm_medium=link&utm_campaign=prestashop-plugin">{l s='Sign in' mod='remarkety'}</a></li>
						<li><a target="_blank" href="https://remarkety.zendesk.com">{l s='Support' mod='remarkety'}</a></li>
						<li><a target="_blank" href="http://www.remarkety.com/blog?utm_source=plugin&utm_medium=link&utm_campaign=prestashop-plugin">{l s='Blog' mod='remarkety'}</a></li>
		...
		<div class="container">
			<div class="row footer_remarkety-bottom">
				...
				<div class="col-lg-6 col-sm-6">
					<p class="copyright">{l s='Made with' mod='remarkety'} <i class="fa fa-heart"></i> {l s='by' mod='remarkety'} <a href="http://www.remarkety.com">{l s='Remarkety' mod='remarkety'}</a></p>
				</div>
			</div>
		</div>
	</footer>
