...
<link rel="stylesheet" type="text/css" http://fonts.googleapis.com/css?family=Raleway:400,700,800&amp;subsetting=all" />
<div class="remarkety_body">
	<section class="section bg-grey">
		<div class="container">	
			<div class="row">
				<div class="col-lg-12">
					<div style="width:200px; margin-left: auto; margin-right:auto;"><a target="_blank" href="http://www.remarkety.com"><img src="{$module_url|escape:'htmlall':'UTF-8'}views/img/remarkety_logo_307x101.png" style="width:200px;"></a></div>
		...
		<div class="container">	
			<div class="row">
				...
				<div class="col-lg-8 col-md-8 col-sm-8 col-md-offset-2">
					<div class="headline"><h1 style="border-bottom: none;">{l s='Store' mod='remarkety'} {if $is_multistore} <strong>{$shop_name|escape:'htmlall':'UTF-8'}</strong> {/if}{l s='is connected' mod='remarkety'}</h1></div>
					<div class="headline"><h1 style="border-bottom: none;">{l s='Welcome to Remarkety - What\'s next?' mod='remarkety'}</h1></div>
					<ol style="font-weight: bold;">
						<li>{l s='Sign in to your account' mod='remarkety'} <a style="color:#007DA0" target="_blank" href="https://app.remarkety.com/">{l s='here' mod='remarkety'}</a></li>
						...
						<li>{l s='Need help? We are here for you:' mod='remarkety'} <a style="color:#007DA0" href="mailto:support@remarkety.com" target="_top">support@remarkety.com</a> <span style="font-family:arial">(+1 800 570-7564)<span></li>
						{if $is_multistore}
	...
	<footer id="footer_remarkety" class="section nopadding-bottom">
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6">
					...
					<ul class="quick-links">
						...
						<li><a target="_blank" href="https://app.remarkety.com/">{l s='Sign in' mod='remarkety'}</a></li>
						<li><a target="_blank" href="https://remarkety.zendesk.com">{l s='Support' mod='remarkety'}</a></li>
						<li><a target="_blank" href="http://www.remarkety.com/blog">{l s='Blog' mod='remarkety'}</a></li>
						<li><a target="_blank" href="http://www.remarkety.com/terms-of-service">{l s='Terms and Conditions' mod='remarkety'}</a></li>
				...
				<div class="col-md-5 col-sm-6">
					<div class="contact-info">
						...
						<ul class="contact-list">
							...
							<li><i class="fa fa-envelope-o"></i><a href="mailto:contact@simplesphere.net.com">support@remarkety.com</a></li>
						</ul>
					</div>
					<!-- End Contact Details  -->
				...
				<div class="col-md-4 bottom-contact">
					<div class="social">
						...
						<!-- Start  Social Links -->
						<ul class="social">
							<li class="facebook"> <a target="_blank" href="https://www.facebook.com/Remarkety"> <i class="fa fa-facebook"></i> </a> </li>
							<li class="twitter"> <a target="_blank" href="https://twitter.com/remarkety"> <i class="fa fa-twitter"></i> </a> </li>
							<li class="google-plus"> <a target="_blank" href="https://plus.google.com/+Remarkety_plus/posts"> <i class="fa fa-google-plus"></i> </a> </li>
							<li class="linkedin"> <a target="_blank" href="https://www.linkedin.com/company/interamind"> <i class="fa fa-linkedin"></i> </a> </li>
						</ul>
						<!-- End Social Links  -->
					</div>				
		...
		<div class="container">
			<div class="row footer_remarkety-bottom">
				...
				<div class="col-sm-4">
					<p class="copyright">{l s='Made with' mod='remarkety' mod='remarkety'} <i class="fa fa-heart"></i> {l s='by' mod='remarkety'} <a href="http://www.remarkety.com">{l s='Remarkety' mod='remarkety'}</a></p>
				</div>
			</div>
		</div>
	</footer>
